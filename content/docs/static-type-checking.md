...
If you have an existing project, [you can click here to learn how to add TypeScript to an existing project](https://facebook.github.io/create-react-app/docs/adding-typescript).
